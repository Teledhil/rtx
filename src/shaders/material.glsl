...
vec3 compute_specular(Material material, vec3 view_direction, vec3 light_direction, vec3 normal) {
...
vec3 compute_specular_lol(Material material, vec3 view_direction, vec3 light_direction, vec3 normal) {
